  ...
  return (
    <div className="px-4 pt-12 flex flex-col items-center justify-center min-h-[80vh]">
      ...
      <div className="w-full space-y-4">
        ...
        <Link
          href="/reports/sqf-quality/new"
          className="flex items-center justify-center gap-3 w-full bg-violet-600 text-white rounded-2xl py-6 text-xl font-semibold active:opacity-90 transition-opacity"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-7 h-7">
